...
export default function UpdateEmployer({ employerId, updateEmployer }) {
    ...
    const schema = yup.object({
        companyName: yup.string().required("This field is required").min(10, "Min 10 character"),
        email: yup.string().email("Enter a valid email").required("This field required"),
        phoneNumber: yup.number("Do not use text characters").required("This field required").min(10, "Min 10 character"),
        webSite: yup.string().url("Enter a valid website").required("This field required")
    })
        ...
        <Formik
            ...
            {({ values, errors, touched, handleSubmit, handleChange }) => (
                <Form
                    ...
                    <Form.Field>
                        <Form.Input fluid icon="sitemap" iconPosition="left" placeholder="Website Address"
                            name="webSite"
                    ...
                    <Form.Field>
                        <Form.Input fluid icon="at" iconPosition="left" placeholder="Email Address"
                            name="email"
                            value={values.email}
                            onChange={handleChange}
                            type="email" />
                    ...
                    <Form.Button compact fluid basic inverted labelPosition="right">
                        <Button compact fluid
                            type="submit" size="large" content="Update"
                            style={{
