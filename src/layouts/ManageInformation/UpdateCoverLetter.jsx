...
export default function UpdateCoverLetter({ unemployedId, updateCv }) {
    ...
    const schema = yup.object({
        letterContent: yup.string().required("This field is required").min(100, "Min 100 character").max(700, "Max 700 character")
    })
                ...
                {({ values, touched, errors, handleChange, handleSubmit, handleBlur }) => (
                    <Form onSubmit={handleSubmit}>
                        <Form.Field>
                            <TextArea rows="7"
                                placeholder={
                                    coverLetter === null ? "Cover letter" : coverLetter.letterContent}
                                name="letterContent"
                        ...
                        <Button
                            ...
                            content={coverLetter === null ? "Add" : "Update"} />
                    </Form>
                )}
            </Formik>
        </div>
