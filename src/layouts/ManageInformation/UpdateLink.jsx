...
export default function UpdateLink({ unemployedId, updateCv }) {
    ...
    const schema = yup.object({
        githubLink: yup.string().url("Enter a Github link").required("This field is required"),
        linkedinLink: yup.string().url("Enter a LinkedIn link").required("This field is required")
    })
                    ...
                    <Grid stackable padded>
                        <Grid.Row>
                            <Grid.Column width="8">
                                <Form.Input
                                    placeholder={
                                        links === null ? "Github Address" : links.githubLink}
                                    name="githubLink"
