        ...
        <div className="pages" style={{ paddingLeft: "1em", paddingRight: "1em" }}>
            ...
            >
                {({ values, errors, handleChange, handleSubmit, touched }) => (
                    <React.Fragment>
                        <Header className="registerHeader" textAlign="center" content="Please fill in the blanks to register" />
                        <Form onSubmit={handleSubmit}>
                            <Segment stacked piled style={{ borderRadius: "10px/10px" }}>

                                {/* First Name and Last Name Validation */}
                                <Form.Field>
                                    <Form.Input fluid icon="add user" iconPosition="left" placeholder="Firstname"
                                        name="firstName"
                                ...
                                <Form.Field>
                                    <Form.Input fluid icon="add user" iconPosition="left" placeholder="Lastname"
                                        name="lastName"
                                ...
                                <Button size="large" compact fluid icon="coffee" labelPosition="right" content="Sign up!"
                                    type="submit"
                                ...
                                <Label className="registerLabel" as={Link} to="/employerRegister"
                                    content="Click here to register as an employer" />
                            </Segment>
                        </Form>
                    </React.Fragment>
                )}
