...
export default function Login() {
    ...
    const schema = yup.object({
        email: yup.string().email("Invalid email address").required("This field cannot be empty"),
                                ...
                                <React.Fragment>
                                    <Form size="small" onSubmit={handleSubmit}>
                                        <Segment stacked piled style={{ borderRadius: "10px/10px" }}>
                                            ...
                                            <Button size="large" compact fluid icon="check" labelPosition="right" content="Log in"
                                                type="submit"
