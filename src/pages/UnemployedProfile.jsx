    ...
    return (
        <div className="pages">
            ...
            <Modal
                ...
                open={openInfo} >
                <Modal.Header className="manageInfoHeader" content="Manage info" />
                    ...
                    <Grid.Column
                            ...
                            <Accordion.Content
                                ...
                                <Table textAlign="center">
                                    <Table.Row>
                                        ...
                                        <Table.HeaderCell content="Depertment Name" />
                                    ...
                                    <Table.Body>
                                        {
                                            cv.educations?.map(education => (
                                                <Table.Row key={education.educationId}>
                                                    ...
                                                    <Table.Cell
                                                        content={education.graduatedDate == null ? "In progress" : education.graduatedDate} />
                                                </Table.Row>
                                            ))
                                        }
                                    </Table.Body>
                            ...
                            <Accordion.Content
                                ...
                                <Table textAlign="center">
                                    <Table.Row>
                                        ...
                                        <Table.HeaderCell content="Language Level(1 - 5)" />
                                    </Table.Row>
                                    <Table.Body>
                                        {
                        ...
                        <Accordion fluid styled style={{ marginBottom: "20px" }}>
                            ...
                            <Accordion.Content
                                ...
                                <Table textAlign="center">
                                    <Table.Row>
                                        <Table.HeaderCell content="Technology Name" />
                                        <Table.HeaderCell content="Technology Level(1 - 5)" />
                                    </Table.Row>
                                    <Table.Body>
                                        {
                                    ...
                                    <Table.Body>
                                        {
                                            cv.jobExperiences?.map(jobExperience => (
                                                <Table.Row key={jobExperience.experienceId}>
                                                    ...
                                                    <Table.Cell
                                                        content={jobExperience.leaveDate == null ? "In progress" : jobExperience.leaveDate} />
                                                </Table.Row>
                                            ))
                                        }
                                    </Table.Body>
