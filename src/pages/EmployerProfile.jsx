                    ...
                    <Grid.Column
                        ...
                        <Accordion fluid styled style={{ marginBottom: "20px", marginTop: "10px" }}>
                            <Accordion.Title
                                ...
                                name="actives"
                                icon="check"
                                content="Published Advertisement"
                            ...
                            <Accordion.Content
                                ...
                                <Table compact stackable
                                    ...
                                    <Table.Row positive>
                                        ...
                                        <Table.HeaderCell content="Expected Salary" />
                                        <Table.HeaderCell content="Quota" />
                                        <Table.HeaderCell content="City" />
                                        <Table.HeaderCell content="Description" />
                                        <Table.HeaderCell content="Employment Type" />
                                        <Table.HeaderCell content="Employment Date" />
                                        <Table.HeaderCell content="Last Application Date" />
                                        <Table.HeaderCell content="Upload date" />
                                        <Table.HeaderCell content="Update Status" />
                                    </Table.Row>
                                    <Table.Body>
                                        {
                            ...
                            <Accordion.Content
                                ...
                                <Table compact stackable
                                    ...
                                    <Table.Row warning>
                                        ...
                                        <Table.HeaderCell content="City" />
                                        <Table.HeaderCell content="Descrition" />
                                        <Table.HeaderCell content="Employment Type" />
                                        <Table.HeaderCell content="Employment Time" />
                                        <Table.HeaderCell content="Upload Date" />
                                        <Table.HeaderCell content="Update Status" />
                                    </Table.Row>
                                    <Table.Body>
                        ...
                        <Accordion fluid styled style={{ marginBottom: "20px" }}>
                            <Accordion.Title
                                ...
                                name="waiting"
                                icon="hourglass half"
                                content="Pending Approval Advertisements"
